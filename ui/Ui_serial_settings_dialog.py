...
class Ui_SerialSettingsDialog(object):
    def setupUi(self, SerialSettingsDialog):
        ...
        self.jlinkCheckBox = QCheckBox(self.rttGroupBox)
        self.jlinkCheckBox.setObjectName(u"jlinkCheckBox")

        self.rttVBoxLayout.addWidget(self.jlinkCheckBox)
    ...
    def retranslateUi(self, SerialSettingsDialog):
        ...
        self.frameTimeoutLabel.setText(QCoreApplication.translate("SerialSettingsDialog", u"\u5206\u5305\u65f6\u95f4\uff1a", None))
