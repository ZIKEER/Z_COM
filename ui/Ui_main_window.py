...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionLogConverter = QAction(MainWindow)
        self.actionLogConverter.setObjectName(u"actionLogConverter")
        ...
        self.menuTool.addSeparator()
        self.menuTool.addAction(self.actionLogConverter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLogConverter.setText(QCoreApplication.translate("MainWindow", u"\u65e5\u5fd7\u8f6c\u6362(&L)...", None))
